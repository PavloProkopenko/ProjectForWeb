                                ...
                                <form method="post" class="row g-3 needs-validation" novalidate>
                                    ...
                                    <div class="col-12">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="rememberMe">Запам'ятай мене.</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <p class="small mb-0">Не маєте облікового запису? <a href="<?=ROOT?>/signup">Створіти обліковий запис</a></p>
                                    </div>
                                </form>
