...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Профіль</li>
            ...
            <div class="card">
                <div class="card-body pt-3">
                    ...
                    <ul class="nav nav-tabs nav-tabs-bordered">
                        ...
                        <li class="nav-item">
                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview">Перегляд</button>
                        </li>

                        <li class="nav-item">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Редагування профілю</button>
                        </li>
                    ...
                    <div class="tab-content pt-2">
                        ...
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-4 label ">Прізвище</div>
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-4 label">Номер телефону</div>
                                <div class="col-lg-9 col-md-8"><?=esc($row->phone)?></div>
                            </div>

                            <div class="row">
                                <div class="col-lg-3 col-md-4 label">Електронна пошта</div>
                        ...
                        <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <label for="firstname" class="col-md-4 col-lg-3 col-form-label">Ім'я</label>
                                    <div class="col-md-8 col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <label for="Phone" class="col-md-4 col-lg-3 col-form-label">Номер телефону</label>
                                    <div class="col-md-8 col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <label for="Email" class="col-md-4 col-lg-3 col-form-label">Електронна пошта</label>
                                    <div class="col-md-8 col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <label for="Twitter" class="col-md-4 col-lg-3 col-form-label">Twitter профіль</label>
                                    <div class="col-md-8 col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <label for="Facebook" class="col-md-4 col-lg-3 col-form-label">Facebook профіль</label>
                                    <div class="col-md-8 col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <label for="Instagram" class="col-md-4 col-lg-3 col-form-label">Instagram профіль</label>
                                    <div class="col-md-8 col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <label for="Linkedin" class="col-md-4 col-lg-3 col-form-label">Linkedin профіль</label>
                                    <div class="col-md-8 col-lg-9">
                                ...
                                <div class="text-center">
                                    <a href="<?=ROOT?>/admin">
                                        <button type="button" class="btn btn-primary float-start"">Повернутися</button>
                                    </a>
                                    <button type="submit" class="btn btn-success float-end">Зберігти зміни</button>
                                </div>
...
<script>
    ...
    {
        document.querySelector(".js-filename").innerHTML = "Обрано файл: " + file.name;
